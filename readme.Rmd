...
- `data` Sensitive health data is not included in this repository, but all other datasets are saved here.
  - `cache_data` This sub-directory houses various ZIP code level data for input into the models. The sensitive data and large files have not been pushed to Github.
